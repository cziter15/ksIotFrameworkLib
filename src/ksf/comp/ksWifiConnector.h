	...
	namespace comps
	{
		class ksWifiConnector : public ksComponent
		{
			...
			protected:
				...
				std::string cachedHostname;											// String to cache hostname.

				/*
					Configures MAC address and hostname for devices using ksIotFrameworkLib.
			...
			public:
				...
				*/
				ksWifiConnector(const std::string& hostname);
